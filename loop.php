...
<?php /* The News Category (slightly different rendering) */ ?>

	<?php if ( in_category( _x('news', 'news category slug', 'macbyte') ) && !is_search() ) : ?>
		<div id="post-<?php the_ID(); ?>" class="news-post">
			<div <?php post_class(); ?>>
				<?php if ( is_single() ) : ?>
					<div class="post-title"><h1><?php the_title(); ?></h1></div>
					<div class="post-date"><?php the_date('j F y')?></div>
				...
				<div class="entry-date"><?php the_date('j F y')?></div>
...
<?php /* How to display all other posts */ ?>
		...
		<?php if ( is_search() ) : ?>
			<div class="post-container">
				<div <?php post_class(); ?>>
					<div class="entry-title"><h2><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'macbyte' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2></div>
